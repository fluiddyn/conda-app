# How to contribute to conda-app

Thank you for considering contributing to conda-app. conda-app is a community-driven
project. It's people like you that make conda-app useful and successful. There are many
...
can be incorporated into conda-app for everyone to use. (Paragraph shamelessly taken and
...
conda-app is part of the wider project FluidDyn. For FluidDyn, we use the revision
